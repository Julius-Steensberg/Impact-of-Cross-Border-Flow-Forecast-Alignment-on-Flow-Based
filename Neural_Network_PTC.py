...
PTC_flows = True  # Set to True if PTC flows are used, False otherwise
NP = False  # Set to True if NP flows are used, False otherwise
...
if PTC_flows:
    ...
    Y = PTC_from_basecase_D1_CGM.copy(deep=True)  # Create a deep copy of the DataFrame
...
scheduler = optim.lr_scheduler.ReduceLROnPlateau(
    optimizer, mode='min', factor=0.5, patience=10)# Train the model
epochs = 300
